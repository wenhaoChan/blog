                        ...
                        <tbody>
                            @foreach($posts as $post)
                                <tr>
                                    ...
                                    <td>{{$post->title}}</td> <td>{{$post->body}}</td> <td>{{$post->user_id}}</td> <td>{{$post->category_id}}</td> <td>{{$post->reply_count}}</td> <td>{{$post->view_count}}</td> <td>{{$post->excerpt}}</td> <td>{{$post->slug}}</td>
